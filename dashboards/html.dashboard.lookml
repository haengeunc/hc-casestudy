- dashboard: html
  ...
  - name: ''
    ...
    body_text: "<div style=\"border: solid 1px #4285F4; border-radius: 5px; padding:\
      ...
      \ src=\"https://services.google.com/fh/files/emails/looker_logo.png\"/>\n\n\t\
      ...
      ></path>\n\n\t\t\t\t\t\t</svg>\n\n\t\t\t\t\tPulse</a>\n\n  <a style=\"padding:\
      \ 5px; line-height: 40px;\" href=\"#news\">\n\n  \t<svg style=\"height: 16px;\
      ...
      ></path>\n\n\t\t\t\t\t\t</svg>\n\n\t\t\t\t\tDemographics</a>\n\n  <a style=\"\
      padding: 5px; line-height: 40px;\" href=\"#contact\">\n\n  <svg  style=\"height:\
  ...
  - name: " (5)"
    ...
    body_text: "<div style='background-color: #fff; padding: 5px 10px; border: solid\
      ...
      <br>\n\n\n\n<svg style='fill: #4285F4; height: 64px;' class=\"svg-icon\" viewBox=\"\
      ...
      \n\n\n<svg style='fill: #EA4335; height: 64px;'  class=\"svg-icon\" viewBox=\"\
      ...
      ></path>\n\n\t\t\t\t\t\t</svg>\n\n\n\n<svg style='fill: #FBBC04; height: 64px;'\
      ...
      ></path>\n\n\t\t\t\t\t\t</svg>\n\n\n\n<svg style='fill: #34A852; height: 64px;'\
  ...
  - name: " (9)"
    ...
    body_text: "<div style=\"font-size: 18px; padding: 5px 10px 0 10px;\">\n\n\t<a\
      ...
      \ 5px 10px; margin-bottom: 10px;' href=\"#\">Business Pulse</a>\n\n\t<a style='display:\
      \ block; border-radius: 5px; padding: 5px 10px; margin-bottom: 10px;' href=\"\
      #\">Demographics</a>\n\n\t<a style='display: block; border-radius: 5px; padding:\
      \ 5px 10px; margin-bottom: 10px;' href=\"#\">Web Analytics</a>\n\n</div>\n"
    row: 11
    col: 0
    width: 6
    height: 5
  ...
  - title: Dynamic welcome message
    ...
    explore: order_items
    type: single_value
    fields: [order_items.welcome_message]
    sorts: [order_items.welcome_message]
    limit: 500
